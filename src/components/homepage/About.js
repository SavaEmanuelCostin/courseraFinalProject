    ...
    return(
        <div id="About" className="about-container-wrapper">
            ...
            <div className="about-featured-photos">
                <div className="about-first-photo bg-image" style={{backgroundImage: `url(${aboutImgFirst})`}}></div>
                <div className="about-second-photo bg-image" style={{backgroundImage: `url(${aboutImgSecond})`}}></div>
            </div>
        </div>
    )
}
